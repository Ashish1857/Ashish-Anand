...
export const ECODEN_PROCESS = [
	...
	{
		content:
			'For this project, I collaborated with another designer throughout the design process. We began with an in-depth competitive analysis, where I personally explored 14–15 similar apps to identify common UX challenges—many of which were overly complex and unintuitive. Our key objective was to simplify the experience without compromising functionality.\n\nNext, we focused on wireframing and defining the information architecture to establish clear, logical navigation. For the UI, we incorporated a glassmorphism-inspired aesthetic to evoke a sense of warmth, comfort, and familiarity—aiming to create a homely feel that resonates with users on an emotional level while maintaining visual clarity and usability.',
	},
	{
		images: [
			{
...
export const CLEVERTAP_PROCESS = [
	{
		content:
			'For this project, I collaborated with another designer throughout the design process. We began with an in-depth competitive analysis of around 14-15 similar apps to identify common UX challenges—many of which were overly complex and unintuitive. Our key objective was to simplify the experience without compromising functionality.\n\nNext, we focused on wireframing and defining the information architecture to establish clear, logical navigation. For the UI, we incorporated a biophilic-inspired aesthetic to evoke a sense of warmth, comfort, and familiarity—aiming to create a homely feel that resonates with users on an emotional level while maintaining visual clarity and usability.',
	},
    {
